  ...
  <div class="products">
    <div class="container">
      ...
      <div class="product-test">
        ...
        <button @click="addNew" class="btn btn-primary float-right">Agregar Orden</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <!-- product sidebar -->
              <div class="col-md-4">
                <h4 class="display-6">Detalle del Producto</h4>
                <hr />
                <div class="form-group">
                  <input
                    type="text"
                ...
                <div class="form-group">
                  <label for="product_image">Imagenes</label>
